...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 560.0, 266.0, 68.0, 22.0 ],
					"text" : "mc.thresh~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 533.0, 179.0, 54.0, 22.0 ],
					"text" : "mc.adc~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 833.280303239822388, 494.494964361190796, 75.0, 22.0 ],
					"text" : "onepole~ 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 837.530303239822388, 576.0, 49.5, 22.0 ],
					"text" : "-~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 868.030303239822388, 541.0, 95.0, 22.0 ],
					"text" : "onepole~ 20000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1103.280303239822388, 488.494964361190796, 75.0, 22.0 ],
					"text" : "onepole~ 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1107.530303239822388, 570.0, 49.5, 22.0 ],
					"text" : "-~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1138.030303239822388, 535.0, 95.0, 22.0 ],
					"text" : "onepole~ 20000"
				}
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						...
						"LowCut[4]" : [ 99.999999999999972 ],
						"LowCut[5]" : [ 150.000000000000057 ],
						"LowCut[6]" : [ 10.0 ],
						"live.gain~[10]" : [ -19.653105003646601 ],
						"live.gain~[1]" : [ -8.703522964851146 ],
						"live.gain~[2]" : [ -14.4767188411398 ],
						"live.gain~[3]" : [ -17.363316779284133 ],
						"live.gain~[4]" : [ -70.0 ],
						"live.gain~[5]" : [ -9.425172449387226 ],
						"live.gain~[6]" : [ 0.0 ],
						"live.gain~[7]" : [ -10.999163844792704 ],
						"live.gain~[9]" : [ -20.480282534290339 ]
					}
,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1049.530303239822388, 476.494964361190796, 41.0, 48.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1013.030303239822388, 428.494964361190796, 41.0, 48.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 969.280303239822388, 488.494964361190796, 75.0, 22.0 ],
					"text" : "onepole~ 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 973.530303239822388, 570.0, 49.5, 22.0 ],
					"text" : "-~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1004.030303239822388, 535.0, 95.0, 22.0 ],
					"text" : "onepole~ 20000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 148.530303239822388, 137.609757900238037, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 89.634811401367188, 66.000013828277588, 340.0, 22.0 ],
...
, 			{
		...
		"parameters" : 		{
			"obj-12" : [ "live.gain~[1]", "EWOUD", 0 ],
			"obj-15" : [ "live.gain~[2]", "PETER", 0 ],
			"obj-19" : [ "live.gain~[6]", "JEPPE", 0 ],
			"obj-22" : [ "live.gain~[7]", "VOX", 0 ],
			"obj-25" : [ "live.gain~[8]", "BAS", 0 ],
			"obj-28" : [ "live.gain~[9]", "DRUMS", 0 ],
			"obj-52" : [ "live.gain~[12]", "INPUT1", 0 ],
			"obj-53" : [ "live.gain~[5]", "OTTO", 0 ],
			"obj-54" : [ "live.gain~[13]", "INPUT2", 0 ],
			"obj-66" : [ "HighCut", "HighCut", 0 ],
			"obj-67" : [ "LowCut", "LowCut", 0 ],
			"obj-68" : [ "LowCut[1]", "LowCut", 0 ],
			"obj-69" : [ "HighCut[1]", "HighCut", 0 ],
			"obj-73" : [ "LowCut[2]", "LowCut", 0 ],
			"obj-74" : [ "HighCut[2]", "HighCut", 0 ],
			"obj-78" : [ "LowCut[3]", "LowCut", 0 ],
			"obj-79" : [ "HighCut[3]", "HighCut", 0 ],
			"obj-83" : [ "LowCut[4]", "LowCut", 0 ],
			"obj-84" : [ "HighCut[4]", "HighCut", 0 ],
			"obj-88" : [ "LowCut[5]", "LowCut", 0 ],
			"obj-89" : [ "HighCut[5]", "HighCut", 0 ],
			"obj-93" : [ "LowCut[6]", "LowCut", 0 ],
			"obj-94" : [ "HighCut[6]", "HighCut", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
