...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 934.0, 278.0, 29.0, 22.0 ],
					"text" : "thru"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 869.0, 1025.0, 29.0, 22.0 ],
					"text" : "thru"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1087.0, 1143.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1132.0, 1113.0, 18.0, 34.0 ],
					"size" : 2,
					"value" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1087.0, 1178.0, 42.0, 22.0 ],
					"text" : "gate 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1013.0, 1658.0, 92.0, 22.0 ],
					"text" : "mc.mixdown~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 806.0, 1620.0, 59.0, 22.0 ],
					"text" : "mcs.limi~"
				}
...
,
					"text" : "spat5.decoder~ @initwith \"/decoding/type hoa3d\" @mc 1 @inputs 8 @outputs 8"
				}
...
,
					"text" : "spat5.pan~ @inputs 20 @outputs 8 @initwith \"/panning/type  hoa3d\" @mc 1"
				}
...
,
					"text" : "spat5.ircamverb @initwith \"/source/number 20, /speaker/number 8\""
				}
...
,
					"text" : "spat5.ircamverb~ @mc 1 @speakers 8 @sources 20"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 806.0, 1658.0, 180.0, 22.0 ],
...
,
					"text" : "spat5.viewer @initwith \"/speaker/number 8\""
				}
